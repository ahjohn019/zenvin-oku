...
<div class="container" style="width:800px">
      ...
      {!! Form::open(array('route'=>'events.store', 'files'=>true)) !!}
          <div class="form-group">
              ...
              {{Form::text('eventName', '',['class' => 'form-control', 'placeholder' => 'Enter event Name','required' => 'required'])}}
          </div>
          <div class="form-group">
              {{Form::label('eventDesc', 'Description*')}}
              {{Form::textarea('eventDesc', '',['class' => 'form-control', 'placeholder' => 'Enter event Description', 'rows' => '5','required' => 'required'])}}
          </div>
          <div class="form-group">
              {{Form::label('eventLocation', 'Venue/Location*')}}
              {{Form::textarea('eventLocation', '',['class' => 'form-control', 'placeholder' => 'Enter Location','rows' => '3','required' => 'required'])}}
          </div>
          <div class="form-group">
            <table class="table">
              <tr>
                <td width="130px">{{Form::label('eventStartDate', 'Start Date*')}}</td>
                <td width="80px">{{Form::date('eventStartDate',null,['class' => 'form-control'])}}</td>
                <td width="140px">{{Form::label('eventEndDate', 'End Date*')}}</td>
                <td width="80px">{{Form::date('eventEndDate',null,['class' => 'form-control'])}}</td>
              </tr>
              <tr>
                <td>{{Form::label('eventStartTime', 'Start Time*')}}</td>
                <td>{{Form::time('eventStartTime',null,['class' => 'form-control'])}}</td>
                <td>{{Form::label('eventEndTime', 'End Time*')}}</td>
                <td>{{Form::time('eventEndTime',null,['class' => 'form-control'])}}</td>
              </tr>
              <tr>
                ...
                <td>{{Form::text('eventPrice', '',['class' => 'form-control', 'placeholder' => 'Enter Price','required' => 'required'])}}</td>
              </tr>
              <tr>
                <td>{{Form::label('eventCouponPrice', 'Coupon Price')}}</td>
                <td>{{Form::text('eventCouponPrice', '',['class' => 'form-control', 'placeholder' => 'Enter Price','required' => 'required'])}}</td>

              </tr>
              <tr>
                <td>{{Form::label('eventCouponDesc', 'Coupon Description')}}</td>
                <td colspan="3">{{Form::textarea('eventCouponDesc', '',['class' => 'form-control', 'placeholder' => 'Enter Description','rows' => '3','required' => 'required'])}}</td>
              </tr>
              <tr>
        ...
        <div class="form-group">
            ...
            {{Form::text('orgID', $ID, ['class' => 'hidden'])}}
